...
if sys.platform.startswith('win32'):
    calling_dir_path = str(working_dir_path) + '\\emotion_extraction'
    TRAINING_FILES_PATH = calling_dir_path + '\\features\\'
    SAVE_DIR_PATH = calling_dir_path + '\\joblib_features\\'
    MODEL_DIR_PATH = calling_dir_path + '\\model\\'
    TESS_ORIGINAL_FOLDER_PATH = calling_dir_path + '\\TESS_Toronto_emotional_speech_set_data\\'
    EXAMPLES_PATH = calling_dir_path + '\\examples\\'
else:
    working_dir_path = calling_dir_path + '/emotion_extraction'
    TRAINING_FILES_PATH = calling_dir_path + '/features/'
    SAVE_DIR_PATH = calling_dir_path + '/joblib_features/'
    MODEL_DIR_PATH = calling_dir_path + '/model/'
    TESS_ORIGINAL_FOLDER_PATH = calling_dir_path + '/TESS_Toronto_emotional_speech_set_data/'
    EXAMPLES_PATH = calling_dir_path + '/emotion_extraction/examples/'
